...
export default function DeleteModal({ id, onClose, onDelete }) {
  ...
  return (
    <div>
      {/* <!-- Main modal --> */}
      <div className="z-50 fixed inset-0 flex justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <div className="fixed w-full h-full bg-black opacity-30" />
        <div className="animate-jump-in relative p-4 w-full max-w-md h-full md:h-auto">
          {/* <!-- Modal content --> */}
